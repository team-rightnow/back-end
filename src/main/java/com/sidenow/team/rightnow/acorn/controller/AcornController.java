...
public class AcornController {
  ...
  @GetMapping
  public Page<AcornResponseDto> getAll(@AuthenticationPrincipal LoginUser loginUser, Pageable pageable) {
    return acornService.getAllAcorn(loginUser.getUser().getId(), pageable);
  }
